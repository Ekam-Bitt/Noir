  ...
  return (
    <div className="mx-auto max-w-4xl px-5 py-12 md:px-8 md:py-16">
      ...
      {items.length ? (
        ...
        <div className="mt-10 rounded-[1.75rem] border border-[#26211f] bg-[#120f0d] px-6 py-16 text-center">
          <p className="text-2xl tracking-[-0.04em] text-[#f5efe8]">FAQs will appear here before launch.</p>
        </div>
      )}
    </div>
  );
